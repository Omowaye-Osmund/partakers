...
// Import images
import lovingSelflesslyImg from "../assets/loving_selflessly.jpg";
  ...
  const purposePoints = [
    {
      ...
      verse: "Hebrews 3:14",
      description:
        "We share in Christ's mission: spreading the gospel, discipling others, and living as lights in our generation.",
    },
    {
      number: "2",
      ...
      verse: "Hebrews 6:4",
      description:
        "Empowered by the Spirit to walk in our God-given gifts and demonstrate that Christ is alive today.",
    },
    {
      number: "3",
      ...
      verse: "Hebrews 12:10",
      description:
        "Pursuing lives set apart for God, growing daily to reflect His character in how we love and live.",
    },
  ];
      ...
      <section className="bg-gradient-to-r from-[#1F1591] via-[#742F8D] to-[#1D4C80] py-12 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p
            ...
            style={fontQuicksand}
          >
            A generation rising to represent Christ on Earth
          </p>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-14 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-10">
            <h2
              className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1F1591] mb-3"
              style={fontLeague}
            >
            ...
            <p
              ...
              style={fontQuicksand}
            >
              Discipling all believers to become:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {purposePoints.map((point, idx) => (
              ...
              >
                ...
                <h3
                  className="text-lg font-bold text-[#1F1591] mb-2"
                  style={fontLeague}
                >
                  {point.title}
                </h3>
                <p
                  className="text-[#742F8D] text-xs font-semibold mb-3"
                  style={fontQuicksand}
                >
                  {point.verse}
                </p>
          ...
          <div className="mt-8 text-center">
            <div className="inline-block bg-gradient-to-r from-[#1F1591] to-[#742F8D] rounded-lg px-6 py-3">
              <p
                className="text-base sm:text-lg text-white font-bold"
                style={fontLeague}
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={fontQuicksand}
            >
              The values that define us and shape our community
            </p>
          </div>
                  ...
                  <div className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-500">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                        <span
                          className="text-xl font-black text-[#1F1591]"
                          style={fontLeague}
                        >
                          {idx + 1}
                        </span>
      ...
      <section className="py-10 sm:py-14 bg-gradient-to-r from-[#1F1591] via-[#742F8D] to-[#1D4C80]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p
            ...
            style={fontQuicksand}
          >
            A community where young believers grow in faith, find their purpose,
