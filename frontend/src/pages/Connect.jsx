...
function Connect() {
  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      <section className="bg-gradient-to-r from-[#1F1591] via-[#742F8D] to-[#1D4C80] py-10 sm:py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <h1
          ...
          <p
            className="text-sm sm:text-base text-[#E4CFB2]"
            style={fontQuicksand}
          >
            Join our community every Sunday
          </p>
      ...
      <section className="py-8 sm:py-10 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-6">
            <h2
              className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1F1591] mb-1"
              style={fontLeague}
            >
              Service Times
            </h2>
          ...
          <div className="bg-white border-2 border-gray-100 rounded-xl p-5 sm:p-6 hover:border-[#91772F] hover:shadow-lg transition-all duration-300 text-center">
            <div className="w-14 h-14 bg-gradient-to-br from-[#1F1591] to-[#742F8D] rounded-lg mb-3 flex items-center justify-center mx-auto">
              <svg
      ...
      <section className="py-8 sm:py-10 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white border-2 border-gray-100 rounded-xl p-5 sm:p-6 hover:border-[#91772F] hover:shadow-lg transition-all duration-300">
            <div className="flex items-start mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-[#1F1591] to-[#742F8D] rounded-lg flex items-center justify-center text-white mr-3 flex-shrink-0">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="flex-1 min-w-0">
                <h3
                  className="text-lg sm:text-xl font-bold text-[#1F1591] mb-1.5"
                  style={fontLeague}
                >
                  Precious House
                </h3>
                ...
                {distance && (
                  <div className="inline-block bg-[#E4CFB2] px-3 py-1.5 rounded-lg mb-3">
                    <p
            ...
            <button
              onClick={handleGetDirections}
              className="w-full bg-gradient-to-r from-[#1F1591] to-[#742F8D] text-white px-5 py-2.5 rounded-lg font-bold text-sm sm:text-base transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
              style={fontQuicksand}
            >
              Get Directions
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            {socialLinks.map((social, idx) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white border-2 border-gray-100 rounded-xl p-4 sm:p-5 hover:border-[#91772F] hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center mb-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg overflow-hidden mr-3 flex-shrink-0 bg-gray-50">
                    <img
                      src={social.icon}
                      alt={social.name}
                      className="w-full h-full object-contain"
                ...
                <p className="text-gray-700 text-xs sm:text-sm mb-2.5" style={fontQuicksand}>
                  {social.handle}
                </p>
                <span
                  className="inline-block bg-gradient-to-r from-[#1F1591] to-[#742F8D] text-white px-4 py-1.5 rounded-lg font-semibold text-xs sm:text-sm"
                  style={fontQuicksand}
                >
                  Follow
                </span>
